                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <h3>Bienvenidos al CRUD de Usuarios</h3>

                                    <a href="srvUsuario?accion=nuevo">
                        <i class="fa fa-plus"></i> Nuevo Usuario </a>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-bag"></i>
                                </div>
                                <a href="srvUsuario?accion=listarUsuarios" class="small-box-footer">Más info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        </div>
                        <!-- ./col -->
